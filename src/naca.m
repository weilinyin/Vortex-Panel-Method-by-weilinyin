...
%
% OPTIONAL INPUT DATA
%   alpha --> Angle of attack (�) (0� default)
...
if sym==1
    title(['NACA 00' num2str(n) ' Airfoil Plot (' num2str(alpha/pi*180) '�)']); % Plot title for two 0 symetric airfoil
    legend([ep,mclp,clp],['NACA 00' num2str(n) ' Airfoil'],'Mean camber line','Chord line');   % Legend for two 0 symetric airfoil
elseif sym==2
    title(['NACA 0' num2str(n) ' Airfoil Plot (' num2str(alpha/pi*180) '�)']); % Plot title for one 0 symetric airfoil
    legend([ep,mclp,clp],['NACA 0' num2str(n) ' Airfoil'],'Mean camber line','Chord line');   % Legend for one 0 symetric airfoil
else
    title(['NACA ' num2str(n) ' Airfoil Plot (' num2str(alpha/pi*180) '�)']); % Plot title for asymetric airfoil
